...
> 每个上线的组合包都在 WorkBuddy / QoderWork / Claude 实测(🚧 为待测)。
>
> 🚧 持续更新中,每周新增组合包。
...
| 职场办公 | [office-assistant](combos/office-assistant) | 1 专家 + 3 技能 | 🚧 | — |
| 销售/BD | [sales](combos/sales) | 1 专家 + 3 技能 | 🚧 | — |

图例：✅ 已实测上线 · 🚧 内容就位、待实测

> 质量红线：**实测过的才标 ✅、才算上线。** 🚧 的组合包内容(专家+技能+资料库)已就位、待实测,绝不冒充实测过。
